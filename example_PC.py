...
def example(method, data, list_target, alpha=0.01, is_discrete=True):
    file = open("D:/Bib-jiaojie(1)/Bib-jiaojie/PC-simple/pyCausalFS/CBD/output/pc.txt", "w+")
    if method == "MBtoPC":
...
if __name__ == '__main__':
    ...
    if data_path == "default":
        data_path = "D:/Bib-jiaojie(1)/Bib-jiaojie/PC-simple/pyCausalFS/CBD/data/datatest.csv"
